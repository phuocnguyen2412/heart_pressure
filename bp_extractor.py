...
class BPExtractor():
    ...
    def read_video(self, video_path):
        ...
        print(f"Video FPS: {self.fps}, Total frames: {total_frames}, Duration: {duration_seconds:.2f}s")
    ...
    def process_single_signal_file(
        ...
        try:
            ...
            visualize_signal(
                ...
                source="r_ch_mean")
            return df["r_ch_mean>cut_start>hpf>bpf_bpm"].values
    ...
    def extract_ppg_from_video(self, video_path):
        ...
        self.process_single_signal_file(
